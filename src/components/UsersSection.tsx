          ...
          <div className="flex gap-4 items-start">
            ...
            <div className="space-y-2">
              <h3 className="text-base font-bold text-slate-800 font-sans">
                Firestore সিকিউরিটি রুলস (Rules) রেস্ট্রিকশন নোটিশ
              </h3>
              <p className="text-xs text-slate-600 leading-relaxed max-w-3xl">
                ফায়ারবেস ডাটাবেজের সিকিউরিটি রুলস অত্যন্ত রেস্ট্রিক্টেড হওয়ায় এই অ্যাডমিন অ্যাপ্লিকেশন থেকে পুরো গ্রাহক তালিকা (Users Directory) একসাথে লোড করা যাচ্ছে না। গ্রাহক প্যানেল বা মেইন সাইটে যেন সাধারণ ভিজিটররা কেউ অন্য কোনো ইউজারের তথ্য দেখতে না পারে, সেজন্য ফায়ারবেস কনসোল ডিফল্টভাবে কেবল নিজের ডাটা পড়ার অনুমতি দেয়।
              </p>
              <p className="text-xs text-amber-700 font-bold leading-relaxed">
                আপনার অ্যাডমিন প্যানেলের সম্পূর্ণ ফিচারের নিরবচ্ছিন্ন অ্যাক্সেস পেতে নিচের নির্দেশাবলী অনুসরণ করে ফায়ারবেস কনসোলে Firestore Rules আপডেট করুন।
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-xs space-y-4 flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-sm font-bold text-slate-800 flex items-center gap-2">
                ...
                রুলস আপডেট করার সহজ ধাপসমূহ:
              </h4>
              
              <ul className="space-y-3 text-xs text-slate-600 pl-1 font-medium font-sans">
                <li className="flex items-start gap-2.5">
                  <span className="text-slate-400 shrink-0 mt-0.5">•</span>
                  <span>প্রথমে আপনার <strong>Firebase Console</strong> এ প্রবেশ করুন: <a href="https://console.firebase.google.com/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline font-bold inline-flex items-center gap-1">console.firebase.google.com</a></span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-slate-400 shrink-0 mt-0.5">•</span>
                  <span>আপনার প্রোজেক্ট সিলেক্ট করে বাম পাশের মেনুবার থেকে <strong>Firestore Database</strong> অপশনে ক্লিক করুন।</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-slate-400 shrink-0 mt-0.5">•</span>
                  <span>উপরের হেডার ট্যাব থেকে <strong>Rules</strong> বাটনে ক্লিক করুন।</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-slate-400 shrink-0 mt-0.5">•</span>
                  <span>ডানদিকের কোড উইন্ডোতে থাকা পূর্বের কোডটি সম্পুর্ণ মুছে ফেলুন এবং ডানপাশের <strong>"Copy Rules"</strong> বাটনে ক্লিক করে কপি করা কোডটি পেস্ট করুন।</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-slate-400 shrink-0 mt-0.5">•</span>
                  <span>সবশেষে উপরে থাকা <strong>Publish</strong> বাটনটিতে ক্লিক করে রুলসগুলো সেভ করে দিন। এরপর এই পেজটি রিফ্রেশ দিন!</span>
                </li>
              </ul>
            </div>
            ...
            <div className="border-t border-slate-100 pt-4 flex items-center gap-3">
              ...
              <p className="text-[10px] text-slate-400 leading-snug">
                রুলস সফলভাবে আপডেট করার সাথে সাথে আপনার অ্যাডমিন অ্যাপের <strong>F7 (Registered Users)</strong> ট্যাবটি সহ প্রতিটি কন্ট্রোল প্যানেল সচল হয়ে যাবে এবং ডাটা চলে আসবে।
              </p>
            </div>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-sm text-slate-300 flex flex-col justify-between space-y-4">
              ...
              >
                {copiedRules ? (
                  ...
                  <>
                    ...
                    <span>Copy Rules (কোড কপি করুন)</span>
                  </>
                )}
              </button>
            </div>
            ...
            <span className="text-[9px] text-slate-500 font-medium block leading-snug">
              * সতর্কতা: এই রুলসটি আপনার প্যানেলের কাস্টমার ট্র্যাকিং, অ্যাকাউন্ট সেটিং ডেটা এবং অর্ডার লিস্টের অ্যাক্সেস উন্মুক্ত করার জন্য। প্রোডাকশনে হাইপার সিকিউরিটি চাইলে নির্দিষ্ট ইমেইলের জন্য কাস্টমার অ্যাডমিন রুলস সেটআপ করতে পারেন।
            </span>
          </div>
    ...
    <div className="space-y-5 select-none no-print">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-slate-50/60 border border-slate-150/80 px-4 py-3.5 rounded-xl flex items-center justify-between">
          <div className="space-y-0.5">
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block font-sans">Registered Customers (গ্রাহক)</span>
        ...
        <div className="bg-slate-50/60 border border-slate-150/80 px-4 py-3.5 rounded-xl flex items-center justify-between">
          <div className="space-y-0.5">
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block font-sans">Administrators (অ্যাডমিন)</span>
            <span className="text-xl font-bold text-slate-800 font-mono">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="সার্চ করুন (নাম, ফোন নম্বর, মেইল বা ঠিকানা দিয়ে)..."
      ...
      {filteredUsers.length === 0 ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-150/80 overflow-hidden shadow-3xs">
          ...
          <div className="hidden lg:flex items-center bg-slate-55 border-b border-slate-150 text-[10px] font-bold text-slate-450 uppercase tracking-wider px-4 py-3 select-none">
            ...
            <div className="min-w-[220px] max-w-[250px] shrink-0 text-left pl-3">নাম ও ইমেইল (Profile)</div>
            <div className="min-w-[150px] shrink-0 text-left">মোবাইল (Phone)</div>
            <div className="min-w-[110px] shrink-0 text-center">মোট অর্ডার (Orders)</div>
            <div className="min-w-0 flex-1 text-left pl-3">শিপিং ঠিকানা (Address)</div>
            <div className="min-w-[190px] shrink-0 text-right pr-3">অ্যাকাউন্ট আইডি ও সময় (Account Info)</div>
          </div>
              ...
              {filteredUsers.map((u, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="hidden lg:flex w-10 shrink-0 items-center justify-center font-mono text-xs font-bold text-slate-400 select-none">
                    ...
                    <div className="flex items-center gap-3 min-w-[220px] max-w-[250px] shrink-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <span className="text-[10px] text-slate-400 block truncate font-medium" title={u.email}>
                    ...
                    <div className="flex items-center gap-2 group min-w-[150px] lg:justify-start shrink-0">
                      ...
                      <div className="min-w-0">
                        <span className="text-[9px] text-slate-400 block lg:hidden uppercase font-bold tracking-tight">মোবাইল (Phone)</span>
                        <div className="flex items-center gap-1">
                          <span className="text-xs font-bold text-slate-700 select-all font-mono">
                            {u.phone || "N/A"}
                          </span>
                          {u.phone && (
                            <button
                    ...
                    <div className="min-w-[110px] shrink-0 flex items-center lg:justify-center">
                      ...
                      <div className="min-w-0">
                        <span className="text-[9px] text-slate-400 block lg:hidden uppercase font-bold tracking-tight mb-0.5">মোট অর্ডার (Orders)</span>
                        <div className="flex items-center gap-1.5">
                          <span className={`px-2.5 py-1 rounded-lg text-[10px] font-black font-sans tracking-tight border inline-flex items-center gap-1 ${
                            ...
                            <span className="text-[9px] font-medium opacity-85">অর্ডার</span>
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-2 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <span className="text-[9px] text-slate-400 block lg:hidden uppercase font-bold tracking-tight">শিপিং ঠিকানা (Address)</span>
                        <div className="flex items-center gap-1.5">
