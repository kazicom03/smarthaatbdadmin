      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="border-t border-slate-100 pt-5 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xs font-black text-slate-600 uppercase tracking-wider font-sans">Bank Transfer Setup</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-500 uppercase">Account Name</label>
              <div className="relative font-sans">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-500 uppercase">Branch Name</label>
              <div className="relative font-sans">
        ...
        <div className="border-t border-slate-100 pt-5 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xs font-black text-slate-600 uppercase tracking-wider font-sans">Delivery Charges</h3>
          </div>
