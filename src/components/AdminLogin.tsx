  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (email.trim() === correctEmail && password === correctPassword) {
        ...
        addToast("success", "Login successful! Welcome to the Admin Panel.");
        onLoginSuccess();
      } else {
        addToast("error", "Incorrect email or password! Please try again.");
      }
      ...
      >
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-8">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1 uppercase tracking-widest font-mono">Admin Authorization Gate</p>
          </div>
        </div>
