...
import { PlusCircle, CreditCard, ClipboardList, ShieldAlert, Wifi, Sliders, Calendar, User, Clock, Loader2, Package, LayoutDashboard, ShieldCheck, Users, LogOut, MessageSquare, Star, Ticket } from "lucide-react";
...
export default function App() {
  ...
  // Navigation
  const [activeTab, setActiveTab] = useState<"dashboardHome" | "productSection" | "paymentSection" | "ordersSection" | "manageProducts" | "trackingSection" | "usersSection" | "messages" | "reviews" | "promoCodes">("dashboardHome");
        ...
        <div className="p-4 border-t border-slate-800 space-y-3">
          <div className="flex items-center gap-2.5 bg-slate-900/60 p-2.5 rounded-xl border border-slate-800/60 shadow-xs">
            ...
            <div className="truncate flex-1">
              <span className="text-[10px] text-slate-500 font-bold block uppercase tracking-wide">Developer access</span>
              <span className="text-white text-xs select-all block truncate font-mono" title="kazicom03@gmail.com">
                kazicom03@gmail.com
              </span>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeTab === "ordersSection" && (
                <OrdersSection orders={orders} onOpenDetails={setSelectedOrderId} />
              )}
              {activeTab === "trackingSection" && (
                <TrackingSection 
                  orders={orders} 
