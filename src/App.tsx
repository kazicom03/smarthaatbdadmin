...
import { PlusCircle, CreditCard, ClipboardList, ShieldAlert, Wifi, Sliders, Calendar, User, Clock, Loader2, Package, LayoutDashboard, ShieldCheck, Users, LogOut } from "lucide-react";
...
export default function App() {
  ...
  // Navigation
  const [activeTab, setActiveTab] = useState<"dashboardHome" | "productSection" | "paymentSection" | "ordersSection" | "manageProducts" | "trackingSection" | "usersSection">("dashboardHome");
