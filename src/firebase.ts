...
// Keep user authenticated anonymously for seamless Firestore operations
signInAnonymously(auth).catch((err) => {
  console.warn("Background anonymous auth failed - running in unauthenticated mode:", err);
});
